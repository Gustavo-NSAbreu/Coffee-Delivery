...
import { AddressFormContainer, AddressInput, BaseInput, CheckoutContainer, CityInput, ComplementInput, DeliveryAddressContainer, DeliveryAddressTitleContainer, InfoContainer, PaymentMethodContainer, PaymentMethodTitleContainer, RadioInputContainer, SelectedCoffeesContainer, StateInput } from "./styles";
...
export default function Checkout() {
  ...
  const isDisabled = currentCart.length === 0;
	...
	function handleDeliveryAddressForm(data: DeliveryAddressFormData) {
		console.log(data);
		const { cep, street, number, complement, neighborhood, city, state, paymentMethod} = data;
		const address = {
			cep,
			street,
			number,
				...
				<section>
					...
					<DeliveryAddressContainer>
						...
						<AddressFormContainer>
							...
							<AddressInput type="text" placeholder="Rua" {...register('street')} />
							<div>
